...
const Navbar = ({ toggleSidebar }) => {
  ...
  return (
    <header className="bg-white px-6 py-4 flex items-center justify-between overflow-hidden">
      {" "}
      {/* FIXED: overflow-hidden to prevent overflow */}
      ...
      <div className="flex items-center gap-4 flex-1 md:flex-none min-w-0">
        {" "}
        {/* FIXED: flex-1 + min-w-0 to prevent title overflow on small screens */}
      ...
      <div className="flex items-center gap-3 flex-none min-w-0">
        {" "}
        {/* FIXED: flex-none + min-w-0 to prevent overflow */}
        {/* Notifications Bell */}
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={filterValue} onValueChange={setFilterValue}>
              ...
              <SelectContent className="">
                ...
                <SelectItem className="" value="paid">
                  Paid
                </SelectItem>
                <SelectItem className="" value="pending">
                  Pending
                </SelectItem>
              </SelectContent>
            </Select>
